...
begin
 ...
 mmoTemp.Clear;
 tmr1.Enabled:=true;
 strngrdCheckList.Enabled := false;
...
//      if FileExists(DirPath + FieldByName(myinifile.readstring('SQL','SaveField','')).AsString+'.pdf') then  continue;
...
procedure TForm4.GetRepExFile(const ExName, SavePath: String);
Var
  RCS : TResourceStream;
begin
